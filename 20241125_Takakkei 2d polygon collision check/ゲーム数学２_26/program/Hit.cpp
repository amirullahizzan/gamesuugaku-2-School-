...
{
	Float2 dir12 = triangle_pos2 - triangle_pos1;
	Float2 dir1p = point - triangle_pos1;

	Float2 dir23 = triangle_pos3 - triangle_pos2;
	Float2 dir2p = point - triangle_pos2;

	Float2 dir31 = triangle_pos1 - triangle_pos3;
	Float2 dir3p = point - triangle_pos3;

	float cross1 = GetFloat2Cross( dir12, dir1p );
	float cross2 = GetFloat2Cross( dir23, dir2p );
	float cross3 = GetFloat2Cross( dir31, dir3p );
